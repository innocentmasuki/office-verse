...
export const erika: WallProps[] = [
    ...
    // Right-top border
    { x: 600 * 2, y: -640, width: 10, height: 980, color: "gray" },
    ...
    // Kitchen border
    // Top
    { x: 1100 * 2, y: -650, width: 10, height: 500, color: "gray" },

    // Bottom
    { x: 1100 * 2, y: 40, width: 10, height: 300, color: "gray" },


    { x: 1450 * 2, y: -300, width: 10, height: 650, color: "gray" },


    // Middle office top border
    { x: 600 * 2, y: -650, width: 350, height: 10, color: "gray" },

    { x: 900 * 2, y: -650, width: 400, height: 10, color: "gray" },
